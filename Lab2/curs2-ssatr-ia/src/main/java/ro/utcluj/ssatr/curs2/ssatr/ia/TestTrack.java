...
public class TestTrack {
   ...
   String getAllCarsDetails(){
    ...
    public static void main(String[] args) {
        ...
        track1.addCar(new ElectricCar("Tesla 1", 0, "CJ01ZZZ"));
        track1.addCar(new ElectricCar("Tesla 2", 0, "CJ01YYY"));
        track1.addCar(new DieselCar("Tesla 2", 0, "CJ01WWW"));
        track1.addCar(new DieselCar("Tesla 2", 0, "CJ01QQQ"));
        track1.addCar(new OttoCar("Opel 1", 0, "CJ01ZZZ"));
        track1.addCar(new OttoCar("Opel 2", 0, "CJ01ZZZ"));
